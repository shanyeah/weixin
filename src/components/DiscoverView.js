...
import IconArrow from '../assets/arrow_down.png'
...
class DiscoverView extends React.Component {
    ...
    componentDidMount() {
        this.state.organId = app.getStgId();
        this.loadData();
        var that = this;
    ...
    loadData(resolve) {
        ...
        netbarService.queryNetbarDetail({ organId: this.state.organId, latitude: latitude, longitude: longitude }, {
    ...
    switchStg() {
        if (app.getUserInfo()) {
            this.props.history.push("/favorite?back=1");
        } else {
    ...
    serachStg() {
        this.props.history.push("/stglist?back=1");
    }
                ...
                >
                    <div className='top_view'>
                        <div className='switch_view'>
                            <div className='switch_button' onClick={this.switchStg.bind(this)}>
                                <div style={{ display: "inline-block" }}>
                                    切换
                            <img style={{ width: "18px", height: "18px", verticalAlign: "middle" }} src={IconArrow}>
                                    </img>
                                </div>
                            </div>
                        </div>
                        <div className='search_view'>
                            <div className='search_button' onClick={this.serachStg.bind(this)}>
                                <div style={{ display: "inline-block" }}>
                                    <img style={{ width: "18px", height: "18px", marginRight: "3px", verticalAlign: "middle" }} src={IconSearch}></img>
                                    搜索附近的门店
                            </div>
                            </div>
                        </div>
