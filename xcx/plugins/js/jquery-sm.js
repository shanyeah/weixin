...
+function ($) {
    ...
    $.initSwipePanels = function () {
        ...
        function handleTouchStart(e) {
            ...
            touchesStart.x = e.type === 'touchstart' ? e.originalEvent.changedTouches[0].pageX : e.pageX;
            touchesStart.y = e.type === 'touchstart' ? e.originalEvent.changedTouches[0].pageY : e.pageY;
            if (swipePanelCloseOpposite || swipePanelOnlyClose) {
